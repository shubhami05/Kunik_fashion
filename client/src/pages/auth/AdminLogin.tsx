...
const AdminLogin: React.FC = () => {
  ...
  const { login, authLoading, isPendingApproval } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        // The error message for pending approval is handled in the login function
          ...
          <div className="max-w-md mx-auto">
            ...
            >
              ...
              <div className="mt-6 text-center text-sm">
                <span className="text-gray-600">Need a customer account?</span>{" "}
